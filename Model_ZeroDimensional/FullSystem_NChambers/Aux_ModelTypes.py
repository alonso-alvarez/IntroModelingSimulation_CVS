...
def BuildModel_FullSixChambers( ):
	...
	VolumeSV = 0.0800   ## [cm3] Volume at diastole (p = 0): Systemic venous
	VolumePV = 0.0000   ## [cm3] Volume at diastole (p = 0): Pulmonar venous
	VolumeLH = 0.0270   ## [cm3] Volume at diastole (p = 0): Left heart
	VolumeLH = 0.0270   ## [cm3] Volume at diastole (p = 0): Right heart
	...
	model = []
	p1 = Compartment( id = 0, strName = 'RightHeart', dias_volume = VolumeLH, initialP = InitialRH ); 
	p1.setCompliance( compliance = CLV_model1, param = [ *CompRH, *tauParam, *heartTime ] )
	p1.setConnectivity( type = 'inlet' , id = 5, resistance = ValveResistance, param = [ ResistanceValveTri ])
	p1.setConnectivity( type = 'outlet', id = 1, resistance = ValveResistance, param = [ ResistanceValvePul ])
	model.append( p1 )

	p1 = Compartment( id = 1, strName = 'PulmonarVenous', dias_volume = VolumePV, initialP = InitialPV ); 
	p1.setCompliance( compliance = ConstantFunction, param = [ CompPV ] )
	p1.setConnectivity( type = 'inlet' , id = 0, resistance = ValveResistance, param = [ ResistanceValvePul ])
	p1.setConnectivity( type = 'outlet', id = 2, resistance = ConstantResistance, param = [ ResistancePul ])
	model.append( p1 )

	p1 = Compartment( id = 2, strName = 'PulmonarArterial', dias_volume = VolumePA, initialP = InitialPA ); 
	p1.setCompliance( compliance = ConstantFunction, param = [ CompPA ] )
	p1.setConnectivity( type = 'inlet' , id = 1, resistance = ConstantResistance, param = [ ResistancePul ])
	p1.setConnectivity( type = 'outlet', id = 3, resistance = ValveResistance, param = [ ResistanceValveMit ])
	model.append( p1 )

	p1 = Compartment( id = 3, strName = 'LeftHeart', dias_volume = VolumeLH, initialP = InitialLH ); 
	p1.setCompliance( compliance = CLV_model1, param = [ *CompLH, *tauParam, *heartTime ] )
	p1.setConnectivity( type = 'inlet' , id = 2, resistance = ValveResistance, param = [ ResistanceValveMit ])
	p1.setConnectivity( type = 'outlet', id = 4, resistance = ValveResistance, param = [ ResistanceValveAor ])
	model.append( p1 )

	p1 = Compartment( id = 4, strName = 'SistemicArterial', dias_volume = VolumeSA, initialP = InitialSA ); 
	p1.setCompliance( compliance = ConstantFunction, param = [ CompSA ] )
	p1.setConnectivity( type = 'inlet' , id = 3, resistance = ValveResistance, param = [ ResistanceValveAor ])
	p1.setConnectivity( type = 'outlet', id = 5, resistance = ConstantResistance, param = [ ResistanceSys ])
	model.append( p1 )

	p1 = Compartment( id = 5, strName = 'SistemicVenous', dias_volume = VolumeSV, initialP = InitialSV ); 
	p1.setCompliance( compliance = ConstantFunction, param = [ CompSV ] )
	p1.setConnectivity( type = 'inlet' , id = 4, resistance = ConstantResistance, param = [ ResistanceSys ])
	p1.setConnectivity( type = 'outlet', id = 1, resistance = ValveResistance, param = [ ResistanceValveTri ])
	model.append( p1 )
